...
import { footerContents } from "~/utils/const";
    ...
    <footer className="mb-4 px-5 flex flex-wrap gap-2">
      {footerContents.map((footerContent, index) => (
        <Link
          ...
          className="text-[#71767b] leading-3 text-[13px] hover:underline"
        >
          {footerContent?.content}
        </Link>
      ))}
      <Popover className="relative inline-flex leading-4">
        <Popover.Button className="text-[#71767b] outline-none leading-3 text-[13px] hover:underline inline-flex items-center">
          More
      ...
      <p className="text-[#71767b] leading-3 text-[13px]">
        &copy; 2023 X Corp.
      </p>
    </footer>
  );
