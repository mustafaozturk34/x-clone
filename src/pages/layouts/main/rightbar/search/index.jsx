...
export default function Search() {
  ...
  return (
    ...
    >
      <label className="h-[43px] rounded-full bg-[#202327] w-full group border border-transparent focus-within:bg-black focus-within:border-[#1d9bf0] relative">
      ...
      {focus && (
        <div className="absolute w-[350px] -translate-y-1 top-full bg-black shadow-box -left-px max-h-[calc(80vh-53px)] rounded-lg text-center min-h-[100px]">
