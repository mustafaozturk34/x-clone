...
export default function Search() {
  ...
  return (
    ...
    >
      <label className="h-[2.688rem] rounded-full bg-[color:var(--background-third)] w-full group border border-transparent focus-within:bg-[color:var(--background-primary)] focus-within:border-[color:var(--color-primary)] relative">
      ...
      {focus && (
        <div className="absolute w-[350px] -translate-y-1 top-full bg-[color:var(--background-primary)] shadow-box -left-px max-h-[calc(80vh-53px)] rounded-lg text-center min-h-[100px]">
