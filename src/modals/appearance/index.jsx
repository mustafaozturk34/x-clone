          ...
          <div className="py-1 px-3 mb-3 grid gap-1 grid-cols-3 bg-[color:var(--background-secondary)] rounded-2xl">
            <button
              ...
              className={classNames(
                "h-16 px-5 bg-white text-[#0f1419] font-bold border border-transparent/10 rounded",
                {
            ...
            <button
              ...
              className={classNames(
                "h-16 px-5 bg-[#15202b] text-[#f7f9f9] font-bold border border-transparent/10 rounded",
                {
                  "!border-[color:var(--color-primary)]":
            ...
            <button
              ...
              className={classNames(
                "h-16 px-5 bg-black text-[#f7f9f9] font-bold border border-transparent/10 rounded",
                {
                  "!border-[color:var(--color-primary)]":
